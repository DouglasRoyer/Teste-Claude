...
export default function NotFound() {
  return (
    <div className="flex flex-1 flex-col">
      <Navbar />
      <main className="relative flex flex-1 items-center overflow-hidden bg-background text-foreground">
        <div className="bg-blueprint-grid pointer-events-none absolute inset-0 opacity-60 [mask-image:radial-gradient(ellipse_70%_60%_at_50%_50%,black,transparent)]" />
